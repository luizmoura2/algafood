...
//	}
	...
	public ResponseEntity<?> handleBDEncontrada(BDException ex, WebRequest request) {
...
//	public ResponseEntity<?> handleValidacaoException(ValidacaoException ex, BindingResult bindingResult,
//	 WebRequest request){//(NegocioException ex, WebRequest request) {
//	 
//	 HttpStatus status = HttpStatus.BAD_REQUEST; ProblemType problemType =
//	 ProblemType.ERRO_NEGOCIO; String detail =
...
//	 request); }
	...
	protected Problem.ProblemBuilder createProblemBuilder(HttpStatus status, ProblemType problemType, String detail) {
